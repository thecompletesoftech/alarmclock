...
class MyTextStyle {
  ...
  static const TextStyle mw50015 = TextStyle(
    fontSize: 15,
    fontFamily: Lato,
    fontWeight: FontWeight.w500,
  );
  ...
  static const TextStyle mw70018 = TextStyle(
    fontSize: 18,
    fontFamily: Lato,
    fontWeight: FontWeight.w700,
  );
  static const TextStyle mw70020 = TextStyle(
    ...
    static const TextStyle mw70014 = TextStyle(
    fontSize: 16,
    fontFamily: Lato,
    fontWeight: FontWeight.w700,
  );
  ...
  static const TextStyle mw60020 = TextStyle(
    fontSize: 20,
    fontFamily: Lato,
  ...
  //fontweight 300
  static const TextStyle mw30016 = TextStyle(
    fontSize: 16,
    fontFamily: Lato,
    fontWeight: FontWeight.w300,
  );
  static const TextStyle mw30012 = TextStyle(
    fontSize: 12,
    fontFamily: Lato,
    fontWeight: FontWeight.w300,
  );
  ...
  //fontweight 400
  static const TextStyle mw40064 = TextStyle(
    fontSize: 64,
    fontFamily: Lato,
    fontWeight: FontWeight.w400,
  );
  static const TextStyle mw40032 = TextStyle(
    fontSize: 32,
    fontFamily: Lato,
    fontWeight: FontWeight.w400,
  );
  static const TextStyle mw40024 = TextStyle(
    fontSize: 24,
    fontFamily: Lato,
    fontWeight: FontWeight.w400,
  );
  ...
  static const TextStyle mw40020 = TextStyle(
    fontSize: 20,
    fontFamily: Lato,
    fontWeight: FontWeight.w400,
  );
  ...
  static const TextStyle mw40015 = TextStyle(
    fontSize: 15,
    fontFamily: Lato,
    fontWeight: FontWeight.w400,
  );
  ...
  static const TextStyle mw40011 = TextStyle(
    fontSize: 11,
    fontFamily: Lato,
    fontWeight: FontWeight.w400,
  );
  ...
  //fontweight 600
    static const TextStyle mw60022 = TextStyle(
    fontSize: 24,
    fontFamily: Lato,
    fontWeight: FontWeight.w600,
  );
